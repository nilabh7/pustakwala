-- ============================================================
-- PUSTAKWALA - Windows Setup Script (run as postgres superuser)
-- Usage: psql -U postgres -f database/windows_setup.sql
-- ============================================================

\echo '--- Step 1: Creating database ---'
DROP DATABASE IF EXISTS pustakwala;
CREATE DATABASE pustakwala ENCODING 'UTF8' LC_COLLATE 'English_United States.1252' TEMPLATE template0;

\echo '--- Step 2: Creating app user ---'
DROP ROLE IF EXISTS pustakwala_user;
CREATE ROLE pustakwala_user WITH LOGIN PASSWORD 'secret';
GRANT ALL PRIVILEGES ON DATABASE pustakwala TO pustakwala_user;

\echo '--- Step 3: Connecting to pustakwala database ---'
\connect pustakwala
...
GRANT ALL ON SCHEMA public TO pustakwala_user;

\echo '--- Step 6: Creating ENUMS ---'
...
\echo '--- Step 10: Granting table permissions ---'
GRANT ALL ON ALL TABLES IN SCHEMA public TO pustakwala_user;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO pustakwala_user;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO pustakwala_user;

\echo '--- Step 11: Inserting seed data ---'
...
VALUES
  ('PUSTAK20', 'Welcome 20 percent Off',     'percentage', 20,  299, 200, 1000, NOW() + INTERVAL '1 year',   '00000000-0000-0000-0000-000000000001'),
  ('FLAT100',  'Flat 100 off on 599 plus',   'fixed',      100, 599, 100,  500, NOW() + INTERVAL '1 year',   '00000000-0000-0000-0000-000000000001'),
  ('BOOKS15',  '15 percent off on all books','percentage', 15,  199, 150, NULL, NOW() + INTERVAL '6 months', '00000000-0000-0000-0000-000000000001');

\echo ''
\echo '============================================='
\echo 'SUCCESS - Pustakwala database is ready!'
\echo 'Admin login: admin@pustakwala.com / Admin@123'
\echo '============================================='
